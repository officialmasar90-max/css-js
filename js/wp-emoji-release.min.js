...
!function(c, l) {
    ...
    c.wp.emoji = new function() {
        var n, e, t = c.MutationObserver || c.WebKitMutationObserver || c.MozMutationObserver, r = c.document, a = !1, o = 0, i = 0 < c.navigator.userAgent.indexOf("Trident/7.0");
        function s() {
        ...
        return function u() {
            if (!a) {
                if (void 0 === c.twemoji)
                    return 600 < o ? void 0 : (c.clearTimeout(e),
                    e = c.setTimeout(u, 50),
                    void o++);
                n = c.twemoji,
                a = !0,
                        ...
                        for (; n--; ) {
                            if (3 === (r = e[n]).nodeType) {
                                if (!r.parentNode)
                                    continue;
                                if (i)
                                    for (; r.nextSibling && 3 === r.nextSibling.nodeType; )
                                        r.nodeValue = r.nodeValue + r.nextSibling.nodeValue,
